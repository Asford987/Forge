...
namespace Forge{
    ...
    class NewArgumentParser: public Parser{
        public:
            NewArgumentParser() : Parser("Usage: forge new <project_name> [options]"){
                ...
                parser.add_argument("g", "git", 0, "The template to use", false, "store_true");
                parser.add_argument("-lib", "lib", 0, "Create a library project", false, "store_true");
            }

            NewArgumentParser& parse_args(int argc, char** argv){
    ...
    class InstallArgumentParser: public Parser{
        public:
            ...
            InstallArgumentParser& parse_args(int argc, char** argv){
    ...
    class UninstallArgumentParser: public Parser{
        public:
            ...
            UninstallArgumentParser& parse_args(int argc, char** argv){
                std::string package_name;
                if(argv[2] == "--help"){
                    parser.print_help();
                    return;
    ...
    class PublishArgumentParser: public Parser{
        public:
            ...
            PublishArgumentParser& parse_args(int argc, char** argv){
                argparse::ArgumentNamespace args = parser.parse_args(argc, argv);
    ...
    class BuildArgumentParser: public Parser{
        public:
            ...
            BuildArgumentParser& parse_args(int argc, char** argv){
                argparse::ArgumentNamespace args = parser.parse_args(argc, argv);
    ...
    class RunArgumentParser: public Parser{
        public:
            ...
            RunArgumentParser& parse_args(int argc, char** argv){
                argparse::ArgumentNamespace args = parser.parse_args(argc, argv);
                this->args["arch"] = args["arch"];
    ...
    class TestArgumentParser: public Parser{
        public:
            ...
            TestArgumentParser& parse_args(int argc, char** argv){
                argparse::ArgumentNamespace args = parser.parse_args(argc, argv);
    ...
    class BenchArgumentParser: public Parser{
        public:
            ...
            BenchArgumentParser& parse_args(int argc, char** argv){
                argparse::ArgumentNamespace args = parser.parse_args(argc, argv);
                this -> args["all"] = args["all"];
                return *this;
            }
